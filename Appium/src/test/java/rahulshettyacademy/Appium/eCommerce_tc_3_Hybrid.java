...
public class eCommerce_tc_3_Hybrid extends BaseTest{
	...
	public void FillForm() throws InterruptedException
	{
		...
		{
		   String ammountString =	productPrices.get(i).getText();
		   Double price = Double.parseDouble(ammountString.substring(1));
		   totalSum=totalSum+price;   //160.97+120
		}
	   
		String displaySum = driver.findElement(By.id("com.androidsample.generalstore:id/totalAmountLbl")).getText();
		
		Double price1 = Double.parseDouble(displaySum.substring(1));
		...
		driver.context("WEBVIEW_com.androidsample.generalstore"); //developer give context mode
		Thread.sleep(2000);
